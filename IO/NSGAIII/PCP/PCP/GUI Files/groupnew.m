...
% Last Modified by GUIDE v2.5 28-Aug-2013 17:26:18
...
set(h.gremove,'callback',{@removegroup,numgrps},'interruptible','off');                           %%Set new control callbacks and their associated group (numgrps)
set(h.gcolset,'callback',{@colourselect,numgrps},'interruptible','off');                          %%Note group number is called as 'a' in the callbacks
set(h.gedit,'callback',{@editgroup,numgrps},'interruptible','off');
