...
public class MOEAD extends Algorithm {
  ...
  /* MAN: if only one layer is adopted, div2_=0 */
  ...
  public SolutionSet execute() throws JMException, ClassNotFoundException {
    int maxEvaluations;
    evaluations_ = 0;
    int maxGenerations = ((Integer) this.getInputParameter("maxGenerations")).intValue();
    //MAN
...
*/
    ...
    //MAN: lambda_ = new double[populationSize_][problem_.getNumberOfObjectives()];
   ...
   // 	System.out.println(lambda_[i][0] + " " + lambda_[i][1]) ;
    ...
    do {
      ...
      for (int i = 0; i < populationSize_; i++) {
        ...
        Solution child; 
        Solution[] parents = new Solution[2]; ///MAN
        ...
        problem_.evaluateConstraints(child); //MAN
        
        evaluations_++;
        
        if(child.getOverallConstraintViolation() < 0) //MAN: avoid infeasible solution
        {
            continue;
        }
